<?php
include "navbar.php"; // Start the session at the very beginning
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO rescue (rescuer_name, animal_type, found_area, additional_info, imagePath, admin_ver) 
          VALUES ('$rescuer_name', '$animal_type', '$found_area', '$additional_info', '$imagePath', 0)";
...
<body>
    ...
    <div id="log" class="container">
        <h1 class="my-4 text-center">Rescue Form</h1>
        <form class="p-3 rounded" action="rescueFormHandler.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
