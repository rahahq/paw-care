...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO `hostel` (`pet_name`, `pet_owner_name`, `pet_type`,  `phone_number`, `appointment_type`, `preferred_date`) VALUES ( '$pet_name', '$pet_owner_name', '$phone_number', '$appointment_type', '$preffered_date')";
